...
def get_ticket_info_api(event_id: str, tokens: dict) -> list:
    ...
    print(f"[DEBUG] Headers: {json.dumps({k: v for k, v in headers.items() if k not in ['User-Agent', 'Host', 'Origin', 'Referer']}, indent=2)}")
